...
const firstLevelMenu: FirstLevelMenuItem[] = [
	{
		...
		route: 'service', name: 'Сервисы', icon: <CoursesIcon />, id: TopLevelCategory.Courses
		route: 'book', name: 'Книги', icon: <CoursesIcon />, id: TopLevelCategory.Courses
		route: 'products', name: 'Продукты', icon: <CoursesIcon />, id: TopLevelCategory.Courses
	}
];
