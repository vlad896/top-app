...
const firstLevelMenu: FirstLevelMenuItem[] = [
	{
		...
		route: 'service', name: 'Сервисы', icon: <ServicesIcon />, id: TopLevelCategory.Courses
		route: 'book', name: 'Книги', icon: <BookIcon />, id: TopLevelCategory.Courses
		route: 'products', name: 'Продукты', icon: <ProductIcon />, id: TopLevelCategory.Courses
	}
];
