		...
		<div className={className} {...props} ref={ref}>
			<Card className={styles.product}>
				...
				<div className={styles.credit}>
					...
					{PriceRU(product.credit)} <span className={styles.creditspan}>/мес</span></div>
				...
				<div className={styles.rateTitle}><a href='#ref' onClick={ToReview}>{product.reviewCount} {forReview(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a></div>
